        ...
        <div class="content">
            ...
            <form method="POST" action="{{ route('editProfile', $loggedUser->id) }}">
                ...
                <div class="form-inputs">
                    ...
                    <input id="password" type="password" class="input-texto @error('password') is-invalid @enderror" name="password" required placeholder="Antiga Senha" autocomplete="old-password">
                    ...
                    <input id="password-confirm" type="password" class="input-texto @error('password-confirm') is-invalid @enderror" name="password_confirmation" placeholder="Nova Senha" autocomplete="new-password">
